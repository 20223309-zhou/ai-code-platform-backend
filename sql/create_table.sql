...
) ENGINE = InnoDB AUTO_INCREMENT = 414678396817305601 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '应用' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 414678479663198209 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '对话历史' ROW_FORMAT = Dynamic;
...
CREATE TABLE `chat_history_original`  (
                                          ...
                                          INDEX `idx_createTime`(`createTime` ASC) USING BTREE,
                                          INDEX `idx_appId_createTime`(`appId` ASC, `createTime` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 414678479491231745 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '对话历史' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 207 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 412543169449906177 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (400410446946095104, 'admin', '734d2f66b73652996d2104ac306a33fe', '管理员', 'https://ai-code-platform-1324613570.cos.ap-chongqing.myqcloud.com/avatar/400410446946095104_SXNzApmwNlspu3rH.jpg', '你好', 'admin', 88, '2', '2026-04-11 11:09:09', '2026-04-11 11:09:09', '2026-05-20 20:04:54', 0);
INSERT INTO `user` VALUES (403664180820008960, 'user', '734d2f66b73652996d2104ac306a33fe', '无名', NULL, NULL, 'user', 5, '0', '2026-04-20 10:38:18', '2026-04-20 10:38:18', '2026-05-20 10:37:46', 1);
INSERT INTO `user` VALUES (412543169449906176, 'test', '734d2f66b73652996d2104ac306a33fe', '无名', NULL, NULL, 'user', 5, '0', '2026-05-14 22:40:16', '2026-05-14 22:40:16', '2026-05-20 10:37:48', 0);
