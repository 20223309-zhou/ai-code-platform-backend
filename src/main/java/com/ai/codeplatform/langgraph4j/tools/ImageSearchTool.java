package com.ai.codeplatform.langgraph4j.tools;
...
import com.ai.codeplatform.langgraph4j.model.enums.ImageCategoryEnum;
...
public class ImageSearchTool {
    ...
    public List<ImageResource> searchContentImages(@P("需要搜索的图片的关键词") String query) {
